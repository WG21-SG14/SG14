...
int main(int argc, char **argv)
{
	...
	benchmark_range_general_use_percentage< plf::pointer_deque<small_struct> >(100, 100000, 1.1, 108000, 1, 4, 4, true);
	...
	benchmark_range_general_use_remove_if_percentage< plf::pointer_deque<small_struct_bool> >(100, 100000, 1.1, 108000, 1, 4, 4, true);
