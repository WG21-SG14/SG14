...
int main(int argc, char **argv)
{
	...
	benchmark_range_general_use_percentage< plf::colony<small_struct> >(100, 100000, 1.2, 108000, 1, 7, 4, true);
	benchmark_range_general_use_percentage< plf::colony<small_struct> >(100, 100000, 1.2, 108000, 5, 7, 4, true);
	benchmark_range_general_use_percentage< plf::colony<small_struct> >(100, 100000, 1.2, 108000, 10, 11, 2, true);
