...
What is a colony? It's similar to a vector or a deque, but different.
...
Colonies don't reallocate - they form chains of increasingly-large blocks of elements, resulting in a fast container which never invalidates pointers or iterators, generally has twice the add-speed of vectors, erasing elements is factors of ten faster, and iteration speed for larger-than-scalar types is similar.
